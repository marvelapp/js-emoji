...
function emoji(){}
	 ...
	 * emoticons. (ie. 😄)
	 *
	 * @returns {string} A new string with all unicode emoticons replaced with the
	 * colon respresentation
	 */
	emoji.replace_unified_with_colons = function(str){
		emoji.init_unified();
		return str.replace(emoji.rx_unified, function(m, p1, p2){
			var val = emoji.map.unified[p1];
			return val ? ':' + emoji.data[val][3][0] + ':': m;
		});
	};
	...
	emoji.data = {
		...
		"1f4a9":[["\uD83D\uDCA9"],"\uE05A","\uDBB9\uDCF4",["poop","shit", "hankey"],20,20,15,0],
	...
	*/
	...
	emoji.img_sets['apple']['sheet'] = "/static/emoji/emoji-data/sheet_apple_64.png";
